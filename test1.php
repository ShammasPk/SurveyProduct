	...
	<body>
		<div class="container">
			...
			<div class="logo">
				...
				<div style="float:right;"><h2>00:00<span>Minutes</span></h2> </div>
				<h1>PSYBO ONLINE TEST <span></span></h1>	
			...
			<section id="q10" class=" set-2 ">
				...
				<table align="center" width="90%" cellpadding="5" cellspacing="5" border="0"> <tr>
					...
					<input type="submit" name="finishbtn" value="finish" class="button" style="margin-left:45%;">
				</div>
